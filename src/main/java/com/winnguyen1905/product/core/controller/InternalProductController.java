...
/**
 * Internal Product REST API Controller
 * 
...
@Validated
@Tag(name = "Internal Products", description = "Internal APIs for service-to-service communication")
public class InternalProductController extends BaseController {
